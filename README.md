...
3 personajes jugables con atributos base distintos
5 pisos con 3 puertas cada uno y encuentros variados
Sistema de reliquias con rareza (Comun, Rara, Legendaria) y sinergias
Pociones de un solo uso dentro del combate
Boss final con combate dinamicas
